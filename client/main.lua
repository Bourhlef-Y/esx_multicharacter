...
if ESX.GetConfig().Multichar then
	...
	-- Au redémarrage de la ressource : garder le NUI masqué si le joueur est déjà en jeu
...
if data == 100 then
	...
	RegisterCommand('perso', function(source, args, rawCommand)
		if ESX.PlayerLoaded then
			TriggerServerEvent('esx_multicharacter:changepersonnage')
		end
	end, false)
